...
const DEFAULT_TLD_NAME = 'com';
const DEFAULT_COMPANY_NAME = 'venndii';
const DEFAULT_PACKAGE_NAME = 'com.venndii.wander';
const DEFAULT_PROJECT_NAME = 'Wander';
const DEFAULT_PROJECT_NAME_ANDROID = 'wander';
